...
void add_seller()
{
    for(int x = num_seller; x < SELLER_COUNT ; x++)
    {
        ...
        cin >> seller_phone_num[x];
        cout << "Enters seller buisness : " << endl;
        cin >> seller_buisness[x];
        cout << "Create password : " << endl;
        cin >> seller_password[x];
        cout << " " << endl;
...
void add_product()
{
    ...
    for(int x = num_products  ; x < PRODUCT_COUNT ; x++)
    {
        ...
        cin >> prices[x];
        cout << "Product entered Successfuly" << endl <<endl <<endl;
        num_products++;
        cout<<"Press 1 to exit";
        cin >> exit;
        if(exit == 1 )
            ...
            char option;
                ...
                while (exit != 'e')
                {
                    ...
                    else if (exit == '2')
                    {
                        ...
                        if (index != -1)
                        {
                            cout << "Welcome  " << user_nameA[index]<< " ." << endl;
